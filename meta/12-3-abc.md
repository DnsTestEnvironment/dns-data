...
<div>
  <div class="my-header">
    <label class="default">a) Anteil nachhaltiger Vergabeverfahren: Deutliche Steigerung
    </label>
  </div>
</div>
<div>
  <div class="my-header">
    <label class="default">b) <abbr title="Kohlenstoffdioxid" tabindex="0">CO₂</abbr>-Emissionen von handelsüblichen Kraftfahrzeugen der öffentlichen Hand je Fahrleistung: signifikante Senkung
      <a href="https://dnsTestEnvironment.github.io/dns-indicators/status"><img src="https://sdg-indikatoren.de/public/Wettersymbole/Wolke.png" title="Der Durchschnittswert zielte in 2022 in die falsche Richtung oder zeigt eine Stagnation an, im vorangegangenen Jahr zeigte sich jedoch eine Wende in die gewünschte Richtung." alt="Wettersymbol: Wolke"/>
      </a>
    </label>
  </div>
</div>
<div>
  <div class="my-header">
    <label class="default">c) Nachhaltige Textilbeschaffung: Steigerung auf 50&nbsp;Prozent bis 2026
    </label>
  </div>
</div>
