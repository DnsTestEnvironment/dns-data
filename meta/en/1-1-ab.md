...
data_footnotes: 'The "Leben in Europa" survey (<abbr title="European Union" tabindex="0">EU</abbr>-SILC), which was previously conducted separately, was integrated into the microcensus as a sub-sample in 2020. Due to the change from a voluntary survey to a survey with general obligation to participate, combined with a new sample composition, it is neither possible to compare the data of the survey year 2020&nbsp;with previous years (break in time series).<br>• From 2020: <abbr title="European Union" tabindex="0">EU</abbr>-27&nbsp;(without <abbr title="United Kingdom" tabindex="0">UK</abbr>).'        
