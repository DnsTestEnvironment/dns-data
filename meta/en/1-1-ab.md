...
target_description: 'Both the proportion of people who are materially and socially deprived (1.1.a) and the proportion of people who are severely materially and socially deprived (1.1.b) should be below the corresponding EU average each year.<br><br>• Based on the target formulation, the difference between the EU value and the value for Germany is calculated for each year. Due to methodological changes in the survey concept, indicator values from 2020 onwards are considered for both indicators.<br>• For both indicators, the difference in 2024 is positive, meaning that the share in Germany is below the EU average. The politically defined targets are therefore achieved for 2024. At the same time, the differences have continuously decreased over the past five years, resulting in a <b>partly cloudy</b> rating for the indicators in 2024.<br><br><u>Note:</u> The reference to the EU shares as the target implies that the indicators can be assessed positively even if the proportions of (severely) materially and socially deprived people in Germany has increased.'        
---
