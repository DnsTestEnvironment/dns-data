...
target_description: '5.1.b: The proportion of women on supervisory boards of listed companies and companies with parity co-determination is to be increased to at least 40 per cent by 2030.<br>• Based on the target formulation, the politically defined target for indicator 5.1.b will already be met by 2026 if the trend of the last six years continues, meaning that the indicator for 2024 is rated as <b>sun</b>.<br><br>5.1.c: The proportion of women in management positions in the federal public sector is to be increased to at least 45 per cent by 2025.<br>• For indicator 5.1.c, no concrete numerical value can be derived from the politically defined target formulation, so that this formulation is interpreted as an interval of ±5 percentage points around the 50 per cent parity. The minimum target value to be achieved is therefore 45 per cent. This value has already been achieved ahead of schedule in 2023, meaning that indicator 5.1.c is rated as <b>sun</b> for 2024.'        
---
