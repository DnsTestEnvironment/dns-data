...
data_state: Last updated on 20/01/2026. Data for further reporting periods will be added as soon as it becomes available.        
...
download_content: https://dnsTestEnvironment.github.io/dns-indicators/public/indicator_downloads_en/6-1-b.pdf        
...
source_organisation_2: <a href="https://www.lanuv.nrw.de/liki/index.php" target="_blank" onclick="return confirm_alert('the Federal States Initiative on Core Indicators', 'En')">Federal States Initiative on Core Indicators</a>
source_organisation_2_short: <a href="https://www.lanuv.nrw.de/liki/index.php" target="_blank" onclick="return confirm_alert('the Federal States Initiative on Core Indicators', 'En')">Federal States Initiative on Core Indicators</a>
source_organisation_logo_2: <a href="https://www.lanuv.nrw.de/liki/index.php" target="_blank" onclick="return confirm_alert('the Federal States Initiative on Core Indicators', 'En')"><img src="https://dnsTestEnvironment.github.io/dns-indicators/public/OrgImgEn/liki.png" alt="Federal States Initiative on Core Indicators" title=" Click here to visit the homepage of the organizationFederal States Initiative on Core Indicators" style="height:60px; width:auto; border:transparent"/></a>
...
source_url_alert_2: the Federal States Initiative on Core Indicators
