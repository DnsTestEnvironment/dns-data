...
target_description: "The proportion of employment relationships covered by collective agreements should be increased.<br><br>• According to the target formulation, both the current value and the six-year average development point to a decline. Indicator 8.5.c is assessed as <b>thunderstorm</b> for 2023.<br><br><a href='https://dnsTestEnvironment.github.io/dns-indicators/en/status'><img src='https://sdg-indikatoren.de/public/Wettersymbole/Blitz.png' title='In 2023&nbsp;neither the average value nor the last change pointed in the right direction.' alt='Weathersymbol: Thuder strom'/></a>'"        
---
