...
data_footnotes: 'The data is based on a special evaluation and is not publicly available.<br>• Age-standardisation: population status: December 31, 2015.<br>• The next data update (time period 2023/2024) is planned for 2025.'        

indicator_pdf:         

graph_titles: 
  - series: <u>time series of the indicator:</u> obesity rate
    title: Obesity rate among children and adolescents
    
  - series: <u>additional time series:</u> overweight rate (without obese)
    title: Overweight rate (without obese) among children and adolescents
    
  - series: <u>additional time series:</u> overweight rate (with obese)
    title: Overweight rate (with obese) among children and adolescents
...
target_description: '<u>Target formulation:</u><br>The proportion of children and adolescents with obesity should decrease or remain constant.<br><br><u>Assessment:</u><br>An assessment of indicator 3.1.e is not possible. Too few data points.'        
---
