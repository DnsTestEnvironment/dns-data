...
target_description: '8.5.a: By 2030, the overall employment rate should be increased to at least 83 per cent.<br>• Based on the target formulation, indicator 8.5.a for the year 2024 is rated as <b>cloud</b>. If indicator 8.5.a maintains the average increase for the years 2019 to 2024, the politically defined target value will not be met in 2030.<br><br>8.5.b: By 2030, the employment rate of older people should be increased to at least 77 per cent.<br>• In the case of indicator 8.5.b, the average development of the last six years suggests that the politically defined target value will be achieved earlier, so that indicator 8.5.b is rated as <b>sun</b> for 2024.'        
---
