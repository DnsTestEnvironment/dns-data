...
target_description: 'Final energy consumption in passenger transport should be reduced to a maximum of 85 per cent of the 2015 level by 2030.<br><br>•  Based on the target formulation, for targets without an exact target value but with a target interval, the weakest target requirement (here: reduction to 85 per cent of the 2015 value) is regarded as the minimum politically defined target to be met. Indicator 11.2.b has fallen significantly on average over the last six years, meaning that the target of 85 per cent is likely to be achieved in 2030 if it is maintained. The indicator is rated <b>sun</b> for 2023.<br><br><u>Note:</u> The target figure of 80 per cent, which is not relevant for this assessment, would also be achieved if the trend is maintained.'        
---
