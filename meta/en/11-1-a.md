...
data_state: Last updated on 13/01/2026. Data for further reporting periods will be added as soon as it becomes available.        
...
download_content: https://dnsTestEnvironment.github.io/dns-indicators/public/indicator_downloads_en/11-1-a.pdf        
...
source_url_text_1: 'Land use: Land use indicator Increase in settlement and transport area (only available in German)'
source_url_alert_1: 
...
source_url_2: 'https://www.regionalstatistik.de/genesis/online?operation=table&code=86321-Z-08&bypass=true&levelindex=1&levelid=1783600398654#abreadcrumb'
source_url_text_2: Average daily change in land used for residential and transportation purposes (moving four-year average)
source_url_alert_2: the Statistical offices of the Federation and the Länder
source_url_2b: 'https://www.regionalstatistik.de/genesis/online?operation=table&code=86321-Z-09&bypass=true&levelindex=1&levelid=1783600533113#abreadcrumb'
source_url_text_2b: Average daily change in land used for residential and transportation purposes (calculated annual values)
source_url_alert_2b: the Statistical offices of the Federation and the Länder
