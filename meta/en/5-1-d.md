...
data_state: Last updated on 30/06/2025. Data for further reporting periods will be added as soon as it becomes available.        
...
download_content: https://dnsTestEnvironment.github.io/dns-indicators/public/indicator_downloads_en/5-1-d.pdf        
...
source_url_alert_1: 
source_url_1b: 'https://www.destatis.de/DE/Themen/Gesellschaft-Umwelt/Soziales/Elterngeld/Tabellen/liste-geburten-bezugsdauer-jahr.html#1422528'
source_url_text_1b: 'Parental and child benefit: Completed benefit payments and average duration of receipt (only available in German)'
source_url_alert_1b: 
...
data_footnotes: 'Introduction of parental allowance plus and partnership bonus: 01/07/2015.<br>• In order to analyse all completed benefit payments for a specific period of birth, the maximum possible payment period must be taken into account, meaning that data can only be displayed with a longer time lag.'        
...
target_description: '<u>Target formulation:</u><br>The proportion of children whose fathers have received parental allowance should increase to at least 65% by 2030.<br><br><u>Assessment:</u><br>According to the target formulation, if the average trend from 2017 to 2022 continues, the indicator value for 5.1.d would only reach about 56% by 2030. The gap to the politically defined target is therefore substantial (over 20% of the difference between the target and the 2022 value), making it unlikely that the target will be achieved. Indicator 5.1.d is therefore assessed as <b>cloud</b> for 2022.<br><br><u>Data status at time of assessment:</u><br>30/06/2025'        
---
