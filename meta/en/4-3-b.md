...
data_state: Last updated on 20/10/2025. Data for further reporting periods will be added as soon as it becomes available.        
...
download_content: https://dnsTestEnvironment.github.io/dns-indicators/public/indicator_downloads_en/4-3-b.pdf        
...
source_organisation_2: <a href="https://www.dipf.de/en/" target="_blank" onclick="return confirm_alert('the DIPF', 'En')">Leibniz Institute for Research and Information in Education</a>
source_organisation_2_short: <a href="https://www.dipf.de/en/" target="_blank" onclick="return confirm_alert('the DIPF', 'En')">Leibniz Institute for Research and Information in Education</a>
source_organisation_logo_2: <a href="https://www.dipf.de/en/" target="_blank" onclick="return confirm_alert('the DIPF', 'En')"><img src="https://dnsTestEnvironment.github.io/dns-indicators/public/OrgImgEn/dipf.png" alt="Leibniz Institute for Research and Information in Education" title=" Click here to visit the homepage of the organizationLeibniz Institute for Research and Information in Education" style="height:80px; width:auto; max-width:100%; object-fit:contain; border:transparent"/></a>
source_url_2: 'https://www.bildungsbericht.de/en/the-national-report-on-education/education-in-germany?set_language=en'
source_url_text_2: National Education Report
source_url_alert_2: the DIPF
...
data_footnotes: 'The data is based on a special evaluation and is not publicly available.<br>• Risk situation: Social risk, risk of formally low-qualified parents and financial risk.<br>&nbsp;&nbsp;- Social risk: Parents are not in employment.<br>&nbsp;&nbsp;- Risk of formally low-skilled parents and financial risk: risk of poverty based on the national equivalent household income.'        
