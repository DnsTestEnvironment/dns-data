...
<div>
  <div class="my-header">
    <label class="default">a) Proportion of sustainable procurement procedures: Significant increase
    </label>
  </div>
</div>
<div>
  <div class="my-header">
    <label class="default">b) CO₂ emissions of vehicles in the public sector: Significant reduction
...
<div>
  <div class="my-header">
    <label class="default">c) Sustainable textile procurement: Increase to 50 per cent by 2026
    </label>
  </div>
</div>
