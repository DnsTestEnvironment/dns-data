...
dns_indicator_definition_new: The indicator shows the value of imports or imports from least developed countries (LDCs) as a share of total imports to Germany (in per cent).        
