...
data_state: Last updated on 07/03/2025. Data for further reporting periods will be added as soon as it becomes available.        

indicator_name: Sustainability-certified cultural and media institutions        
section: Sustainable production        
postulate: Reflecting values and production patterns        
...
download_content: https://dnsTestEnvironment.github.io/dns-indicators/public/indicator_downloads_en/12-2-b.pdf        
...
source_organisation_logo_4: <a href="https://www.greenculture.info/" target="_blank" onclick="return confirm_alert('the Green Culture', 'En')"><img src="https://dnsTestEnvironment.github.io/dns-indicators/public/OrgImgEn/gc.png" alt="Green Culture" title=" Click here to visit the homepage of the organizationGreen Culture" style="height:80px; width:auto; max-width:100%; object-fit:contain; border:transparent"/></a>
source_url_4: 'https://www.kmk.org/fileadmin/pdf/PresseUndAktuelles/2023/Anleitung_zum_CO2-Kulturrechner.pdf'
source_url_text_4: ClimateBalanceCulture and ClimateBalanceCulture+ (only available in German)
source_url_alert_4: the Green Culture

source_active_5: true
source_organisation_5: <a href="https://www.dihk.de/de" target="_blank" onclick="return confirm_alert('the German EMAS Advisory Board', 'En')">German EMAS Advisory Board based on data from the Association of German Chambers of Commerce and Industry</a>
source_organisation_5_short: <a href="https://www.dihk.de/de" target="_blank" onclick="return confirm_alert('the German EMAS Advisory Board', 'En')">German EMAS Advisory Board based on data from the Association of German Chambers of Commerce and Industry</a>
source_organisation_logo_5: <a href="https://www.dihk.de/de" target="_blank" onclick="return confirm_alert('the German EMAS Advisory Board', 'En')"><img src="https://dnsTestEnvironment.github.io/dns-indicators/public/OrgImgEn/dihk.png" alt="German EMAS Advisory Board based on data from the Association of German Chambers of Commerce and Industry" title=" Click here to visit the homepage of the organizationGerman EMAS Advisory Board based on data from the Association of German Chambers of Commerce and Industry" style="height:80px; width:auto; max-width:100%; object-fit:contain; border:transparent"/></a>
source_url_5: 'https://www.emas.de/statistiken/'
source_url_text_5: EMAS statistics (only available in German)
source_url_alert_5: the German EMAS Advisory Board
...
source_url_text_6: Ecological standards for German cinema, TV and online/vod productions (only available in German)
...
target_description: '<u>Target formulation:</u><br>The number of sustainability-certified cultural and media institutions should be increased.<br><br><u>Assessment:</u><br>An assessment of indicator 12.2.b is not possible. Too few data points.'        
---
