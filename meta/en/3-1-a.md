...
target_description: 'Avoidable mortality through prevention and treatment should be reduced to a maximum of 200&nbsp;deaths per 100,000&nbsp;inhabitants by 2030.<br><br>• According to the target formulation, indicator 3.1.a is assessed as <b>thunderstorm</b> for 2021. On average over the past six years, the indicator value has increased, indicating a trend contrary to the desired direction.<br>• Data status at assessment: 03/09/2024.<br><br><a href="https://dnsTestEnvironment.github.io/dns-indicators/en/status"><img src="https://sdg-indikatoren.de/public/Wettersymbole/Blitz.png" title="In 2021&nbsp;the distance to the target was constantly high or had increased. Thus, the indicator did not develop in the desired direction." alt="Weathersymbol: Thuder strom"/></a>'        
---
