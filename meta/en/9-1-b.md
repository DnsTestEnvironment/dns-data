...
target_description: The proportion of households with access to gigabit broadband is to be increased to 100 per cent by 2025.<br><br><br>• Based on the target formulation, if the average increase of the years 2019 to 2024 continues (the values of the second half of the year are taken into account in each case), only around 85 per cent of households will have a corresponding connection by 2025. Indicator 9.1.b is rated as <b>cloud</b> for the year 2024.        
---
