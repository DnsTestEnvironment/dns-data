...
data_state: Last updated on 11/02/2026. Data for further reporting periods will be added as soon as it becomes available.        
...
source_url_1: 'https://datacube.uba.de/vis?pg=0&bp=true&snb=4&vw=tb&df[ds]=ds-dc-release&df[id]=DF_AIR_EMISSIONS_INDEX&df[ag]=UBA&df[vs]=2026.0&dq=A...&pd=2000,2024&to[TIME_PERIOD]=false&lc=en'
...
data_footnote: 'Average index of measured values: Sulphur dioxide (SO₂), nitrogen oxides (NOₓ), non-methane volatile organic compounds (NMVOCs) and particulate matter (PM₂.₅).'        
