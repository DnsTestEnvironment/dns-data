...
target_description: '<u>Target formulation:</u><br>The increase in the degree of soil sealing should be reduced.<br><br><u>Assessment:</u><br>An assessment of indicator 15.3&nbsp;is not possible. Too few data points.<br><br>'        
---
