...
target_description: The proportion of sensitive terrestrial ecosystems that exceed the eutrophication thresholds should be reduced to a maximum of 52 per cent by 2030.<br><br>• Based on the target formulation, indicator 15.2 will be around 60 per cent in 2030 if the trend of the last six years continues. Due to the large gap to the politically defined target value, indicator 15.2 is rated as <b>cloud</b> for 2019.        
---
