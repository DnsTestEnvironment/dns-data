...
dns_indicator_definition_new: The indicator shows the consolidated gross debt of the government (in accordance with the Maastricht Treaty) in relation to gross domestic product (GDP) in current prices (in per cent). The indicator serves as a measure of government debt.        

dns_political_intention: The Stability and Growth Pact of the European Union (EU) sets the reference value for the maximum debt ratio at 60&nbsp;per cent of gross domestic product (GDP).        

political_target: Ratio of government debt to gross domestic product (GDP) must not exceed 60&nbsp;per cent; To be maintained until 2030        
