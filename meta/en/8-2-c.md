...
target_description: 'The ratio of government debt to gross domestic product should not exceed 60% each year.<br><br>• According to the target formulation, indicator 8.2.c exceeded the politically defined target in 2024. Furthermore, the average trend from 2019&nbsp;to 2024&nbsp;points to a further increase. Indicator 8.2.c is therefore assessed as <b>thunderstorm</b> for 2024.<br>• Data status at assessment: 25/02/2025.<br><br><a href="https://dnsTestEnvironment.github.io/dns-indicators/en/status"><img src="https://sdg-indikatoren.de/public/Wettersymbole/Blitz.png" title="In 2024&nbsp;the target value was missed and the indicator had not moved towards the target on average over the previous changes." alt="Weathersymbol: Thuder strom"/></a>'        
---
